...
#ifndef CR4SHEDMACH_SWIFT_H
#define CR4SHEDMACH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Cr4shedMach",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Cr4shedMach12CrashSession")
@interface CrashSession : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_EXTERN void cr4shed_mach_init(void) SWIFT_NOEXCEPT;
